# Producer.InternalSecurity example

This example is **producer-only**, contains **no external cache**, and contains **no consumer logic**.
...
```powershell
dotnet run --project .\JohBloch.ConfluentKafka.Clients.Example.Producer.InternalSecurity.csproj
```
