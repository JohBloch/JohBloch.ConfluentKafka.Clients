namespace JohBloch.ConfluentKafka.Clients.Services.Serialization.Json
{
    ...
    public class JsonSerializer<T> : IMessageSerializer<T>
    {
        ...
        /// </summary>
        public JsonSerializer(JohBloch.ConfluentKafka.SchemaRegistryExtClient.Interfaces.ISchemaRegistryExtClient schemaRegistry, ILogger<JsonSerializer<T>> logger)
        {
